...
<img style=" width:180px; height:180px;" alt="详细内容" src="../PowerBank/VPT-PB<?php echo $row["tl_bm"]?>/VPT-PB<?php echo $row['tl_bm'] ?>.jpg" /></a>
...
<td colspan="3" bgcolor="#ffffff"><div align="center"><?php echo $key?></div></td> 
            ...
            <!--分页内容介绍-->
            <!--<div class="DashedLine mb20"></div>-->   <!--不要下虚线-->
			</div>
       </div>
       <!--右侧内容结束-->
</div>
