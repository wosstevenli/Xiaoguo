...
$rs_offers = $db->select_alldata("SELECT * FROM  `offer` ORDER BY  `offer`.`id` desc");
...
<title><?php echo $rs_navs["nav6"];?></title>
<style type="text/css">
...
<div class="Content">
        ...
        <div class="mb15"><img width="1000" height="250" alt="" src="../images/banner/<?php echo $rs_bnavs["nav6"];?>"></div>

		<?php include "leftside.php" ?>
        
        <div class="RightSide">
            <div class="Location">当前位置：<a href="/">首页</a> 〉<span class="Blue"><span id="labName"><?php echo $rs_navs["nav6"];?></span></span></div>
...
$sql="select * from offer ORDER BY id desc limit $offset,$Page_size"; 
$result=mysql_query($sql,$link); 
while ($row=mysql_fetch_array($result)) { 
?> 
<tr> 
<td bgcolor="#E0EEE0" height="25px" width="210px"><div align="left"><a href="../psys/careersinfo.php?id=<?php echo $row['id'] ?>">  
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['title']?> 
</a></div></td> 
<td bgcolor="#E0EEE"><div align="left"><a href="../psys/careersinfo.php?id=<?php echo $row['id'] ?>"> 
&nbsp;&nbsp;&nbsp;&nbsp;<span class="Blue"><?php echo substr($row['contents'],0,60); ?>... </span>
</a></div></td>
<td bgcolor="#E0EEE"><div align="left"><a href="../psys/careersinfo.php?id=<?php echo $row['id'] ?>"><img style=" margin-left:8px; margin-top:5px;" alt="详细内容" src="../images/more.gif" /></a>
</div></td>  
</tr> 
<?php 
} 
