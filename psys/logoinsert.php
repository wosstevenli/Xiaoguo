...
<title>公司信息更新LOGO-后台管理-深圳市伟富创光电科技有限公司</title>
...
?>
<!--添加上传图片-->
<?php echo "你好，你上传的LOGO".$_FILES["newsphoto"]["name"]."已经成功上传至images"; ?>
...
$sql="UPDATE  `vptdatebase`.`compinfo` SET  `logo` =  '".$_FILES["newsphoto"]["name"]."' WHERE  `compinfo`.`id` =1;";
