...
<title><?php echo $rs_navs["nav1"];?></title>
...
<div class="Content">
        ...
        <div class="mb15"><img width="1000" height="250" alt="" src="../images/banner/<?php echo $rs_bnavs["nav1"];?>"></div>
        <!--左侧导航-->
        ...
        <!--右侧内容-->
        <div class="RightSide">
            <div class="Location">当前位置：<a href="/">首页</a> 〉<span class="Blue"><span id="labName"><?php echo $rs_navs["nav1"];?></span></span></div>
