...
$rs_enavs = $db->select_onedata($sql_enavs);*/  //中英文在同一行
...
<title><?php echo $rs_navs["nav5"];?></title>
<style type="text/css">
...
<div class="Content">
        ...
        <div class="mb15"><img width="1000" height="250" alt="" src="../images/banner/<?php echo $rs_bnavs["nav5"];?>"></div>

		<?php include "leftside.php" ?>
        
        <div class="RightSide">
            <div class="Location">当前位置：<a href="/">首页</a> 〉<span class="Blue"><span id="labName"><?php echo $rs_navs["nav5"];?></span></span></div>
...
?> 
<tr> 
<td bgcolor="#E0EEE0" height="25px" width="210px"><div align="left"><a href="../psys/newsinfo.php?id=<?php echo $row['id'] ?>">  
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row['title']?> 
</a></div></td> 
<td bgcolor="#E0EEE"><div align="left"><a href="../psys/newsinfo.php?id=<?php echo $row['id'] ?>"> 
&nbsp;&nbsp;&nbsp;&nbsp;<span class="Blue"><?php echo substr($row['contents'],0,64); ?>... </span>
</a></div></td>
<td bgcolor="#E0EEE"><div align="left"><a href="../psys/newsinfo.php?id=<?php echo $row['id'] ?>"><img style=" margin-left:8px; margin-top:5px;" alt="详细内容" src="../images/more.gif" /></a>
</div></td>  
</tr> 
<?php 
} 
